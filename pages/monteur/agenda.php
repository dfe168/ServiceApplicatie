<!-- 
---------------bron: https://bootsnipp.com/snippets/PEZZ7
 -->
...
var data = [],
    ...
    h, 
    m,
    names = ['Foutcode 302', 'Papier loop vast', 'Start niet op', 'Print niet', 'Streep op de afdruk'],
    slipsum = ["(hier komt de machine gegevens en klantgegevens)<br> DEMO "];
